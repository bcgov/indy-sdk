...
async def test_open_custom_postgres_storage_works():
    ...
    wallet_credentials = '{"key": "key", "storage_credentials": {"account": "postgres", "password": "mysecretpassword", "admin_account": "postgres", "admin_password": "mysecretpassword"}, "key_derivation_method": "ARGON2I_MOD"}'
