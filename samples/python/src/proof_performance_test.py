...
async def run(wallet_type):
    ...
    transcript_schema = {
        'name': 'Transcript',
        'version': '1.2',
        'attr_names': ['first_name', 'last_name', 'degree', 'status', 'year', 'average', 'ssn', 'inonce']
    }
    ...
    for i in range(100):
        ...
        alice_master_secret_name = 'alice_master_secret' + str(i)
        ...
        # claim_for_predicate2 = claims_for_job_application_proof_request['predicates']['predicate2_referent'][0]
        #
        ...
        #
        # logger.info("\"Alice\" -> claims_for_job_application_proof " +
        #             json.dumps(claims_for_job_application_proof, indent=4))
        #
        ...
        #
        # logger.info("\"Alice\" -> schemas_json " +
        #             schemas_json)
        # logger.info("\"Alice\" -> claim_defs_json " +
        #             claim_defs_json)
        # logger.info("\"Alice\" -> revoc_regs_json " +
        #             revoc_regs_json)
        #
        ...
        #
        # logger.info("\"Acme\" -> call verifier_verify_proof() job_application_proof_request_json=" +
        #             json.dumps(job_application_proof_request_json), indent=4)
        # logger.info("\"Acme\" -> call verifier_verify_proof() decrypted_job_application_proof_json=" +
        #             json.dumps(decrypted_job_application_proof_json), indent=4)
        #
